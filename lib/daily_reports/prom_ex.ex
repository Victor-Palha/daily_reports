defmodule DailyReports.PromEx do
  @moduledoc """
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule DailyReportsWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :daily_reports
  ...
  use PromEx, otp_app: :daily_reports
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: DailyReportsWeb.Router, endpoint: DailyReportsWeb.Endpoint},
      Plugins.Ecto
      # Plugins.Oban,
      ...
      # DailyReports.Users.PromExPlugin
    ]
  end
  ...
  def dashboards do
    [
      ...
      # {:daily_reports, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
